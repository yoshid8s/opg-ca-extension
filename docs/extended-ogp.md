...
* Website information
* Author information
* Third-party certification authorities information, etc.
...
Actual authenticity verification is performed
through OP/CAS-related verification mechanisms,
not by OGP metadata itself.
...
実際の真正性検証は、OGPメタデータ自体ではなく、OP/CAS関連の検証メカニズムを通じて行われます。
